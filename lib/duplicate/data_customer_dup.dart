...
class DataCustomerDupPage extends StatefulWidget {
  const DataCustomerDupPage({Key? key}) : super(key: key);

  @override
  State<DataCustomerDupPage> createState() => _DataCustomerDupPageState();
}

class _DataCustomerDupPageState extends State<DataCustomerDupPage> {
  UserModel? _user;
